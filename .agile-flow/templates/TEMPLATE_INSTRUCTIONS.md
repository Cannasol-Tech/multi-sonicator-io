...
__metadata__:
  ...
  company: Axovia AI
  title: Template Format for the Agile Flow Agentic Coding Framework
  brief: Specification for BMAD document templates
  file: .agile-flow/templates/TEMPLATE_INSTRUCTIONS.md
  date: 2025-09-11
  version: 1.0
  tags:
    - template
...
LLM: INITIALIZATION INSTRUCTIONS - TEMPLATE

---
> ~* Axovia AI's  ~•Axovia•ƒløw™•~ Agentic Agile Framework

# Axovia AI Template Format
