...
exports.HardwareInterface = void 0;
 ...
 */
class HardwareInterface extends events_1.EventEmitter {
    constructor() {
        super();
    ...
    initializePinStates() {
        ...
        const initialPins = [
            { pin: 'D7', signal: 'FREQ_DIV10_4', direction: 'IN' },
            { pin: 'D8', signal: 'FREQ_LOCK_4', direction: 'IN' },
            { pin: 'A2', signal: 'OVERLOAD_4', direction: 'IN' },
            { pin: 'A3', signal: 'START_4', direction: 'OUT' },
                ...
                try {
                    ...
                    if (cand.startsWith('/') || cand.startsWith('.')) {
                        if (fs_1.default.existsSync(cand)) {
                            ...
                            try {
                                fs_1.default.realpathSync(cand);
                            }
                            catch {
                                continue;
                            }
                        ...
                        // Resolve via PATH
                        const res = (0, child_process_1.spawnSync)('which', [cand], { encoding: 'utf8' });
...
`
    ...
    async retryConnection(maxAttempts = 3, delayMs = 2000) {
