...
export function setupRoutes(app: Express, hardwareInterface: HardwareInterface, testAutomationService?: TestAutomationService) {
  ...
  app.get('/api/test/scenarios/search', async (req: Request, res: Response) => {
    if (!testAutomationService) {
      return res.status(503).json({
        error: 'Test automation service not available',
        timestamp: Date.now()
  ...
  app.get('/api/test/tags/categorized', async (req: Request, res: Response) => {
    if (!testAutomationService) {
      return res.status(503).json({
        error: 'Test automation service not available',
        timestamp: Date.now()
  ...
  // Get tag presets
  app.get('/api/test/tags/presets', (req: Request, res: Response) => {
    if (!testAutomationService) {
      return res.status(503).json({
        error: 'Test automation service not available',
        timestamp: Date.now()
  ...
  app.post('/api/test/tags/presets', (req: Request, res: Response) => {
    if (!testAutomationService) {
      return res.status(503).json({
        error: 'Test automation service not available',
        timestamp: Date.now()
  ...
  app.get('/api/test/history', (req: Request, res: Response) => {
    if (!testAutomationService) {
      return res.status(503).json({
        error: 'Test automation service not available',
        timestamp: Date.now()
  ...
  app.get('/api/test/statistics', (req: Request, res: Response) => {
    if (!testAutomationService) {
      return res.status(503).json({
        error: 'Test automation service not available',
        timestamp: Date.now()
  ...
  app.get('/api/test/export/:executionId', async (req: Request, res: Response) => {
    if (!testAutomationService) {
      return res.status(503).json({
        error: 'Test automation service not available',
        timestamp: Date.now()
  ...
  app.delete('/api/test/history', (req: Request, res: Response) => {
    if (!testAutomationService) {
      return res.status(503).json({
        error: 'Test automation service not available',
        timestamp: Date.now()
