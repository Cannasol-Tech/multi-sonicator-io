...
{.agile-flow/.banners/auto-generated.md} # A Company Identifying banner ust be placed at the top of the file 
...
version: 1.0
dependencies:
  - file: ../../.agile-flow/flow-config.yaml
    type: flow-config
    required: true
    description: Agile Flow configuration
commands:
  - generate_cicd:
      type: task
      flowFile: ../../.agile-flow/flows/generate-cicd.yaml
...
```yaml
# <!-- Generated by Agile Flow™ Agentic Framework -->
# file: .agile-flow/config/services.yaml
