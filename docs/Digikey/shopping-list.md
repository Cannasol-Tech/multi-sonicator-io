...
## Sonicator Interface Components

### Digital-to-Analog Converters (DACs)
- **MCP4725 I2C DAC Breakout** (12-bit, 0-5V)
  - DigiKey P/N: `MCP4725A0T-E/CH-ND`
  - Qty: 4
  - Unit Price: ~$2.50
  - Note: Need operational amplifier circuit to scale to 0-10V

### Analog-to-Digital Converters (ADCs)
- **ADS1115 16-bit ADC Module** (I2C)
  - DigiKey P/N: `296-41336-5-ND`
  - Qty: 2
  - Unit Price: ~$5.00
...
- **DB9 Male PCB Mount** (Right Angle)
...
### Notes:
1. **Enclosure**: Order separately (Hammond Manufacturing or similar)
