@requirement_FR5 @story_0_3_AC3 @story_0_3_AC4 @story_0_3_AC7
Feature: Monitoring via MODBUS
  # PRD §4, §5, §10

  @req-power @prd-10-api @reg-40013-40016 @hil @pending
  ...
  @req-frequency @prd-10-api @reg-40017-40020 @hil @pending
  ...
  @req-status-flags @prd-10-api @reg-40021-40024 @hil @pending
